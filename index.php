...
<body class="w-full flex flex-col items-center min-h-screen font-['Roboto']">
    <main class="w-[1140px] flex flex-col items-center" id="top">
        ...
        <a href="#top" class='fixed h-16 w-16 bg-bgcol z-50 bottom-10 right-10 rounded-full text-textCBG text-3xl flex text-center justify-center items-center transition-all ease-in' title='A' id='scrollToTop'>A</a>
        ...
        <form class="w-[60dvw] bg-gray-100 flex flex-col gap-4 rounded-md p-8 fixed right-50 top-[10dvh] z-50" name="reservation" method="POST" id='modal' onSubmit='closeModal()'>
            <h2 class="text-center text-4xl">Rezervácia skipasu</h2>
            <input class="bg-white p-2 flex text-end text-gray-200" type="text" name="skipas_name" placeholder="Celé meno" value="<?php echo($name); ?>" required>
            <input class="bg-white p-2 flex text-end text-gray-200" type="email" name="skipas_email" placeholder="Kontaktný email" value="<?php echo($mail); ?>" required>
            <input class="bg-white p-2 flex text-end text-gray-200" type="text" name="skipas_phone" placeholder="Kontaktné telefónne číslo" value="<?php echo($phone); ?>" required>
            ...
            <input class="bg-white p-2 flex text-end text-gray-200" value="<?php echo($days); ?>" type="number" name="skipas_days" placeholder="Počet dní" min="1" value="1" required>
            <input class="bg-white p-2 flex text-end text-gray-200" type="date" value="<?php echo($date); ?>" name="skipas_date" placeholder="Termín" required>
            <h3 class="text-center text-2xl">Počet osôb</h3>
            <input class="bg-white p-2 flex text-end text-gray-200" value="<?php echo($children); ?>" onChange='updatePrice()' type="number" name="skipas_people_children" placeholder="Dieťa (6-11r.)" id="children" value="0" min="0" required>
            <input class="bg-white p-2 flex text-end text-gray-200" value="<?php echo($juniors); ?>" onChange='updatePrice()' type="number" name="skipas_people_juniors" placeholder="Junior (12-17r.)" id="juniors" value="0" min="0" required>
            <input class="bg-white p-2 flex text-end text-gray-200" value="<?php echo($adults); ?>" onChange='updatePrice()' type="number" name="skipas_people_adults" placeholder="Dospelý (18-59r.)" id="adults" value="0" min="0" required>
            <input class="bg-white p-2 flex text-end text-gray-200" value="<?php echo($seniors); ?>" onChange='updatePrice()' type="number" name="skipas_people_seniors" placeholder="Senior (60r.+)" id="seniors" value="0" min="0" required>
            <h3 class="text-center text-2xl">Výsledná cena: <span id="price">0</span>E</h3>
            <button class="bg-none border border-white hover:bg-textDarker transition-all ease-in" type="submit" name="submit_reservation">Rezervovať</button>
            <button class="bg-none border border-white hover:bg-textDarker transition-all ease-in" type="button" onClick='closeModal()'>Zavrieť</button>
        </form>
        ...
        <header class="w-full flex flex-row justify-center items-center bg-fill bg-no-repeat bg-main h-[60dvh] text-white gap-8">
            ...
            <form class="flex flex-col gap-3" name="newsletter" method="POST">
                ...
                <input class="bg-white p-2 flex text-end text-gray-200" type="text" name="newsletter_user" placeholder="Zadajte svoje meno" min="4" max="64" value="<?php echo($user) ?>" required>
                <input class="bg-white p-2 flex text-end text-gray-200" type="email" name="newsletter_email" placeholder="Zadajte emailovú adresu" value="<?php echo($mail) ?>" required>
                <button class="bg-none border border-white hover:bg-textDarker transition-all ease-in" type="submit" name="submit_newsletter">Odoslať</button>
            </div>
        </header>
        <article class="w-full p-16 flex flex-row items-center justify-center text-center bg-[#E4E2E0]">
            <div class="flex flex-col justify-center items-center text-center h-full w-full">
                ...
                <span class="italic text-sm">Ponúkame širokú škálu zjazdoviek pre všetky úrovne zručností, vrátane náročných zjazdoviek pre pokročilých, ako aj miernych zjazdoviek pre začiatočníkov a rodiny s deťmi.            </span>
            </div>
            <div class="flex flex-col justify-center items-center text-center h-full w-full">
                <h3 class="text-[120px] text-white font-bold">02.</h3>
                <h2 class="text-textDark text-[50px]">Prekrásna <br /> príroda</h2>
                <span class="italic text-sm">Stredisko sa nachádza v krásnej horskej oblasti a ponúka nádherné výhľady na okolitú prírodu. Okrem lyžovania a snowboardingu tu môžete využiť aj množstvo ďalších aktivít.
                </span>
            </div>
            <div class="flex flex-col justify-center items-center text-center h-full w-full">
                <h3 class="text-[120px] text-white font-bold">03.</h3>
                <h2 class="text-textDark text-[50px]">Lyžiarska <br /> škola</h2>
                <span class="italic text-sm">Lyžiarska škola je skvelou možnosťou pre začiatočníkov, ktorí sa chcú naučiť lyžovať alebo snowboardovať. Lyžiarski inštruktori poskytujú individuálne alebo skupinové lekcie.</span>
            </div>
        </article>
        <article class="text-white grid-special grid grid-cols-12 grid-rows-3 w-full h-[50dvh]">
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in row-span-2 col-span-4 flex flex-col justify-between p-8 items-center bg-cover bg-no-repeat" style="background-image: url(images/res02.jpg)">
                <div class="flex flex-col gap-2 text-center">
                    <h2 class="text-4xl">Špeciálna ponuka</h2>
                    <h3 class="text-md">UŠETRITE 25%</h3>
                </div>
                <button class="w-48 text-md font-bold bg-none border border-white hover:bg-textDarker transition-all ease-in" onClick='openModal(1)'>Rezervovať skipas</button>
            </div>
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in row-span-2 col-span-4 flex flex-col justify-between p-8 items-center bg-cover bg-no-repeat" style="background-image: url(images/res02.jpg)">
                <div class="flex flex-col gap-2 text-center">
                ...
                <button class="w-48 text-md font-bold bg-none border border-white hover:bg-textDarker transition-all ease-in" onClick='openModal(2)'>Rezervovať skipas</button>
            </div>
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in row-span-2 col-span-4 flex flex-col justify-between p-8 items-center bg-cover bg-no-repeat" style="background-image: url(images/res02.jpg)">
                <div class="flex flex-col gap-2 text-center">
                ...
                <button class="w-48 text-md font-bold bg-none border border-white hover:bg-textDarker transition-all ease-in" onClick='openModal(3)'>Rezervovať skipas</button>
            </div>
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in col-span-3 flex justify-center items-center bg-cover bg-no-repeat p-8" style="background-image: url(images/res02.jpg)">
                <h2 class="text-4xl">Štrbské Pleso</h2>
            </div>
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in col-span-3 flex justify-center items-center bg-cover bg-no-repeat p-8" style="background-image: url(images/res02.jpg)">
                <h2 class="text-4xl">Veľké Solisko</h2>
            </div>
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in col-span-3 flex justify-center items-center bg-cover bg-no-repeat p-8" style="background-image: url(images/res02.jpg)">
                <h2 class="text-4xl">Kriváň</h2>
            </div>
            <div class="hover:text-black filter grayscale hover:grayscale-0 transition-all ease-in col-span-3 flex justify-center items-center bg-cover bg-no-repeat" style="background-image: url(images/res02.jpg)">
                <h2 class="text-4xl">Končistá</h2>
            </div>
        </article>
        <article class="p-8 gap-8 bg-bgcol text-textDark flex flex-col w-full text-center justify-center items-center">
            ...
            <div class="grid grid-cols-3 grid-rows-2 gap-8">
                <div class="flex flex-col text-center justify-center items-center">
                    ...
                    <h3 class="text-textDarker text-4xl">Reštaurácie</h3>
                ...
                <div class="flex flex-col text-center justify-center items-center">
                    ...
                    <h3 class="text-textDarker text-4xl">Nočný život</h3>
                ...
                <div class="flex flex-col text-center justify-center items-center">
                    ...
                    <h3 class="text-textDarker text-4xl">Wellness</h3>
                ...
                <div class="flex flex-col text-center justify-center items-center">
                    ...
                    <h3 class="text-textDarker text-4xl">Obchody</h3>
                ...
                <div class="flex flex-col text-center justify-center items-center">
                    ...
                    <h3 class="text-textDarker text-4xl">Ubytovanie</h3>
                ...
                <div class="flex flex-col text-center justify-center items-center">
                    ...
                    <h3 class="text-textDarker text-4xl">Kurzy</h3>
        ...
        <article class="flex flex-row w-full justify-evenly">
            <div class="w-full bg-cover bg-no-repeat" style="background-image: url(images/foot01.jpg)">
                
            </div>
            <div class="w-full flex flex-col justify-center items-center text-center p-8 gap-2 bg-bgcol">
            ...
            <div class="w-full bg-cover bg-no-repeat" style="background-image: url(images/foot02.jpg)">
